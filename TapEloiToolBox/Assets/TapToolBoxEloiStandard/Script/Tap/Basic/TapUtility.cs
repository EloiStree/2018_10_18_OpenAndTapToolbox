...
public class TapUtility : MonoBehaviour {
    ...
    public static CharacterToEloiStandard[] EloiStandard = new CharacterToEloiStandard[] {
        ...
        new CharacterToEloiStandard('a', HandType.Left, TapCombo.TOO___),
        new CharacterToEloiStandard('b', HandType.Left, TapCombo.T_OO__),
        new CharacterToEloiStandard('c', HandType.Left, TapCombo.T__OO_),
        new CharacterToEloiStandard('d', HandType.Left, TapCombo.T___OO),
        new CharacterToEloiStandard('e', HandType.Left, TapCombo.TO_O__),
        new CharacterToEloiStandard('f', HandType.Left, TapCombo.T_O_O_),
        new CharacterToEloiStandard('g', HandType.Left, TapCombo.T__O_O),
        new CharacterToEloiStandard('h', HandType.Left, TapCombo.TO__O_),
        new CharacterToEloiStandard('i', HandType.Left, TapCombo.T_O__O),
      ...
      //new CharacterToEloiStandard('z', HandType.Left, TapCombo.TOOO__),
        new CharacterToEloiStandard('l', HandType.Left, TapCombo.TOO_O_),
        new CharacterToEloiStandard('m', HandType.Left, TapCombo.TO_OO_),
        new CharacterToEloiStandard('n', HandType.Left, TapCombo.TOO__O),
        new CharacterToEloiStandard('o', HandType.Left, TapCombo.T_O_OO),
        new CharacterToEloiStandard('p', HandType.Left, TapCombo.T_OO_O),
        new CharacterToEloiStandard('q', HandType.Left, TapCombo.TO__OO),
        new CharacterToEloiStandard('r', HandType.Left, TapCombo.TO_O_O),
        new CharacterToEloiStandard('s', HandType.Left, TapCombo.T_OOOO),
        new CharacterToEloiStandard('t', HandType.Left, TapCombo.TO_OOO),
        new CharacterToEloiStandard('u', HandType.Left, TapCombo.TOO_OO),
        new CharacterToEloiStandard('v', HandType.Left, TapCombo.TOOO_O),
        new CharacterToEloiStandard('w', HandType.Left, TapCombo.TOOOO_),
